# Chunk 07: Persona & Tone, Prompts/Examples / Nhân vật & Giọng điệu, Ví dụ Prompt

**Chunk ID:** `01_INTRODUCTION_chunk_07`  
**Section:** I.11 Persona & Tone, I.12 Prompts/Examples  
**Word Count:** ~320 words  
**Retrieval Keywords:** persona, tone, AI behavior, bilingual, system prompt template, user prompt examples  
**Related Chunks:** `01_INTRODUCTION_chunk_06`, `02_ROLES_BEHAVIORS_chunk_01`  
**Canonical Summary Reference:** `01_INTRODUCTION_summary_section_11_12`
...
**Previous Chunk:** `01_INTRODUCTION_chunk_06`  
**Related Section:** `02_ROLES_BEHAVIORS` (for detailed behavior rules)
