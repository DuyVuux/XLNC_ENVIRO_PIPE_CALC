# Chunk 04: Module 3 Formulas - Mixing/Reaction / Công thức Module 3 - Ngăn trộn Phản ứng

**Chunk ID:** `04_DOMAIN_KNOWLEDGE_BASE_chunk_04`  
**Section:** IV.2.3 Module 3 - Rapid Mixing/Reaction Formulas  
**Word Count:** ~400 words  
**Retrieval Keywords:** Module 3, mixing, reaction, tank volume, reaction rate, Fe²⁺, H₂S, first-order, second-order, TCVN 7222:2002  
**Related Chunks:** `04_DOMAIN_KNOWLEDGE_BASE_chunk_03`, `04_DOMAIN_KNOWLEDGE_BASE_chunk_05`  
**Canonical Summary Reference:** `04_DOMAIN_KNOWLEDGE_BASE_summary_section_2_3`
...
Module 3 formulas: Mixing tank volume V = Q × t, mixing time t = V/Q, tank dimensions L = V/(H×W), first-order reaction rate r = k×[A], second-order reaction rate r = k×[A]×[B], Fe²⁺ oxidation rate r_Fe = k_Fe×[Fe²⁺]×[O₂], H₂S oxidation rate r_H₂S = k_H₂S×[H₂S]×[O₂], concentration after time t [A]_t = [A]_0×e^(-k×[O₂]×t), reaction efficiency η = ([A]_0 - [A]_t)/[A]_0 × 100%.

**Hóa phàm:**

Module 3 tính ngăn trộn phản ứng: thể tích ngăn trộn, thời gian trộn, kích thước ngăn, tốc độ phản ứng oxy hóa Fe²⁺ và H₂S, và hiệu suất phản ứng.

---

**Previous Chunk:** `04_DOMAIN_KNOWLEDGE_BASE_chunk_03`  
**Next Chunk:** `04_DOMAIN_KNOWLEDGE_BASE_chunk_05` (Module 4 & 5 Formulas - Settling & Filtration)
